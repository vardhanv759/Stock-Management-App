...
def authenticate(username1, password):
    correct_username = "LidosHotel_2024"
    correct_password = "Parsa@5950?"
    return username1 == correct_username and password == correct_password
